...
for idx=1:length(session)
    ...
    h1=fopen(['data/augment/Augment_train_DREAMS_sub' num2str(num_subject{idx}) '_' num2str(num_steps) '_' num2str(subset*100) '%_f' num2str(target_f) '_mf.txt'],'wt');
    h2=fopen(['data/augment/Augment_train_DREAMS_sub' num2str(num_subject{idx}) '_' num2str(num_steps) '_' num2str(subset*100) '%_f' num2str(target_f) '_mf_labels.txt'],'wt');
    h3=fopen(['data/augment/Augment_valid_DREAMS_sub' num2str(num_subject{idx}) '_' num2str(num_steps) '_' num2str(subset*100) '%_f' num2str(target_f) '_mf.txt'],'wt');
    h4=fopen(['data/augment/Augment_valid_DREAMS_sub' num2str(num_subject{idx}) '_' num2str(num_steps) '_' num2str(subset*100) '%_f' num2str(target_f) '_mf_labels.txt'],'wt');
    h5=fopen(['data/augment/Augment_test_DREAMS_sub' num2str(num_subject{idx}) '_' num2str(num_steps) '_' num2str(subset*100) '%_f' num2str(target_f) '_mf.txt'],'wt');
    h6=fopen(['data/augment/Augment_test_DREAMS_sub' num2str(num_subject{idx}) '_' num2str(num_steps) '_' num2str(subset*100) '%_f' num2str(target_f) '_mf_labels.txt'],'wt');
